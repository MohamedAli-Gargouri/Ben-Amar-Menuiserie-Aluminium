...
const HSBHeader = () => {
  ...
  return (
    ...
    >
      ...
      >
        Découvrez nos services chez Ben Amar Menuiserie Aluminium: volets
        roulants, portes extérieures, façades vitrées, Alucobond, et plus
        encore. Transformez votre espace avec notre expertise.
      </p>
    </motion.div>
  );
};
